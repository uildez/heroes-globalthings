    ...
    return (
        <div className={`flex items-center justify-between w-full bg-zinc-800 px-4 py-2 rounded-lg border-l-8 ${Active === true ? "border-green-500" : "border-red-500"}`}>
            ...
            <div className='flex flex-col gap-2'>
                <button className='flex w-full items-center justify-center gap-2 px-2 py-1 text-xs rounded-md border-2 border-zinc-700 hover:bg-green-600 transition-all'>
                    Editar
